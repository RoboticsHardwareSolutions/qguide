...
- [[#Установка qeletcrotech|Установка qeletcrotech]]
- [[#Установка плагина для генерации клемных блоков|Установка плагина для генерации клемных блоков]]
	- [[#Установка плагина для генерации клемных блоков#Windows:|Windows:]]
	- [[#Установка плагина для генерации клемных блоков#macOS:|macOS:]]
- [[#Общая структура проектов|Общая структура проектов]]
	- [[#Общая структура проектов#Примеры декомпозиции проектов|Примеры декомпозиции проектов]]
	- [[#Общая структура проектов#Общая структура репозитория|Общая структура репозитория]]
- [[#Работа над проектом  qelectrotech|Работа над проектом  qelectrotech]]
- [[#Типовая структура проекта|Типовая структура проекта]]
- [[#Оформление листов проекта|Оформление листов проекта]]
- [[#Нумерация|Нумерация]]
- [[#Создание компонентов и работа с ними|Создание компонентов и работа с ними]]
- [[#Работа с клеммными блоками|Работа с клеммными блоками]]
...
В свойствах элемента при создании небходимо указывать название на двух языках **en** и **ru**:

![[qguide 2024-05-10 17.49.58.excalidraw]]

При создании элемента помимо непосредственно УГО требуется еще расположить 2 dynamic text field c определенным размером шрифта:
1) Label 
2) Article Number 

![[qguide 2024-05-10 17.25.29.excalidraw|700]]
...
УГО компонентов на схеме должны быть читаемыми после печати листов проекта. Каждый УГО компонента который является объектом спецификации должен содержать рядом с собой позиционное обозначение и поле  Article Number. 
![[qguide 2024-05-07 20.28.47.excalidraw|600]]
